    ...
    <div className='wrapper flex_align_justify'>
        <div className='terms_condition'>
            ...
            <div className='tc_item tc_body'>
                <ol>
                   ...
                   <li>
                      ...
                      <p>We provide online birthday event management services. By using our platform to organize birthday events, you acknowledge that you have read and understood the specific event details and requirements.</p>
                   </li>
                   <li>
            ...
            <div className='tc_item tc_foot flex_align'>
                 ...
                 <Link to="/"> <button className='tc_accept_btn'>Accept</button></Link>
            </div>
        </div>
    </div>
    </div>
